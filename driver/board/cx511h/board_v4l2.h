...
/* LED GPIO pin accessor functions (defined in board_config.c) */
extern int board_get_led_pin_r(void);
extern int board_get_led_pin_g(void);
extern int board_get_led_pin_b(void);
